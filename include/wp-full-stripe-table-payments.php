...
class WPFS_Payments_Table extends WP_List_Table
{
                ...
                foreach ($columns as $column_name => $column_display_name)
                {
                    ...
                    switch ($column_name)
                    {
                        ...
                        case "created":
                            ...
                            break;
                        case "actions":
                            echo '<td ' . $attributes . '>' . '<button class="button delete" data-id="' . $rec->paymentID . '" data-type="payment">Delete (local)</button></td>';
                            break;
                    }
                }
